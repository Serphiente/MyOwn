...
class ContactsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $companies = \App\ContactCompany::get()->pluck('name', 'id')->prepend(trans('quickadmin.qa_please_select'), '');$ordendecompras = \App\Ordendecompra::where('contacto_id', $id)->get();

        $contact = Contact::findOrFail($id);

        return view('admin.contacts.show', compact('contact', 'ordendecompras'));
    }

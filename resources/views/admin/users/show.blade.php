            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <th>@lang('quickadmin.users.fields.banco')</th>
                            <td field-key='banco'>{{ $user->banco }}</td>
                        </tr>
                        <tr>
                            <th>@lang('quickadmin.users.fields.tipocuentabanco')</th>
                            <td field-key='tipocuentabanco'>{{ $user->tipocuentabanco }}</td>
                        </tr>
                        <tr>
                            <th>@lang('quickadmin.users.fields.cuentabancaria')</th>
                            <td field-key='cuentabancaria'>{{ $user->cuentabancaria }}</td>
                        </tr>
                        <tr>
...
<li role="presentation" class="active"><a href="#useractions" aria-controls="useractions" role="tab" data-toggle="tab">Acciones de Usuario (Traza)</a></li>
</ul>

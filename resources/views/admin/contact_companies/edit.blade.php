...
@section('content')
    ...
    {!! Form::model($contact_company, ['method' => 'PUT', 'route' => ['admin.contact_companies.update', $contact_company->id]]) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('rut', trans('quickadmin.contact-companies.fields.rut').'*', ['class' => 'control-label']) !!}
